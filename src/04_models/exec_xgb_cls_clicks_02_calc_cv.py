...
from globals import FEATURES, ID2TYPE, INPUT, LOGS, OOF, OUTPUT
...
def main():
    ...
    train_labels = pd.read_parquet(INPUT / "local-validation_chris/test_labels.parquet")
