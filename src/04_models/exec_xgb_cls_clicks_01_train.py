...
common_settings = {
    ...
    "features_info": {
        ...
        FEATURES / "base_session_and_aid_features_train_type_0.parquet": ["session", "aid"],
        FEATURES / "word2vec_features_session_and_aid_last1_train_type_0.parquet": ["session", "aid"],
        FEATURES / "word2vec_features_session_and_aid_last5_train_type_0.parquet": ["session", "aid"],
        FEATURES / "word2vec_features_session_and_aid_all_train_type_0.parquet": ["session", "aid"],
        FEATURES / "cvm_features_all_train_type_0.parquet": ["session", "aid"],
        FEATURES / "cvm_features_last1_train_type_0.parquet": ["session", "aid"],
        FEATURES / "cvm_features_last5_train_type_0.parquet": ["session", "aid"],
        # base
