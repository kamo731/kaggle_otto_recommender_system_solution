...
from exec_xgb_cls_clicks_01_train import common_settings
...
feature_info_test = {
    ...
    FEATURES / "base_session_and_aid_features_test_type_0.parquet": ["session", "aid"],
    FEATURES / "word2vec_features_session_and_aid_last1_test_type_0.parquet": ["session", "aid"],
    FEATURES / "word2vec_features_session_and_aid_last5_test_type_0.parquet": ["session", "aid"],
    FEATURES / "word2vec_features_session_and_aid_all_test_type_0.parquet": ["session", "aid"],
    FEATURES / "cvm_features_all_test_type_0.parquet": ["session", "aid"],
    FEATURES / "cvm_features_last1_test_type_0.parquet": ["session", "aid"],
    FEATURES / "cvm_features_last5_test_type_0.parquet": ["session", "aid"],
    # base
