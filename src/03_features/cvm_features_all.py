...
def main():
    ...
    candidates = calc_weight_of_session(candidates, df_last1week, df_carts_orders, n_record="all", cvm_name="buys")
    ...
    candidates = calc_weight_of_session(candidates, df_last1week, df_buy2buy, n_record="all", cvm_name="buy2buy")
    ...
    candidates = calc_weight_of_session(candidates, df_last1week, df_clicks, n_record="all", cvm_name="clicks")
    ...
    candidates.to_parquet(FEATURES / f"cvm_features_all_{phase}_type_{type_id}.parquet")
